...
const Footer = () => {
  return (
    <footer className="py-10 px-4 md:px-0 pb-0 text-base-content bg-[#ebebeb] dark:bg-base-100">
      <div className="max-w-7xl w-[95%] md:w-[93%] mx-auto">
        <div className="footer">
          ...
          <nav>
            <h6 className="footer-title text-lg text-black dark:text-white">Services</h6>
          ...
          <nav>
            <h6 className="footer-title text-lg text-black dark:text-white">Company</h6>
          ...
          <nav>
            <h6 className="footer-title text-lg text-black dark:text-white">Legal</h6>
        ...
        <aside className="footer-center pb-5 dark:text-white text-sm font-medium text-gray-600">
